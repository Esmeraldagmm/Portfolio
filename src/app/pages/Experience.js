...
export function Experience() {
  return (
    ...
    >
      <h1 className="text-4xl text-center font-bold pt-10 mb-12">Experience</h1>
      <div className="w-full max-w-screen-2xl px-8 gap-y-8 grid grid-cols-1 md:grid-cols-3 gap-x-8">
        ...
        <div className="rounded-3xl flex flex-col bg-gray-900 bg-opacity-80 gap-y-4">
          <div className="border-t-4 border-t-blue-400 rounded-t-xl p-8">
            ...
            <h4 className="text-lg text-gray-500 mb-2">Jul 2024 - Present</h4>
            <p className="text-lg text-white font-light">
              ...
              timely repairs, and provide operational support for technology
              usage.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-3xl flex flex-col bg-gray-900 bg-opacity-80 gap-y-4">
          <div className="border-t-4 border-t-blue-400 rounded-t-xl p-8">
            ...
            <h4 className="text-lg text-gray-500 mb-2">Aug 2024 - Present</h4>
            <p className="text-lg text-white font-light">
